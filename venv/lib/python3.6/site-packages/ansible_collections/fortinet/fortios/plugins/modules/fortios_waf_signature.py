...
def fortios_waf(data, fos, check_mode):
    ...
    fos.do_member_operation('waf_signature')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["waf_signature"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "waf_signature")
