...
def filter_system_automation_trigger_data(json):
    option_list = ['description', 'event_type', 'fabric_event_name',
                   'fabric_event_severity', 'faz_event_name', 'faz_event_severity',
                   'faz_event_tags', 'fields', 'ioc_level',
                   'license_type', 'logid', 'name',
                   'report_type', 'serial', 'trigger_day',
...
def system_automation_trigger(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('system', 'automation_trigger', filtered_data, vdom=vdom)
        current_data = fos.get('system', 'automation_trigger', vdom=vdom, mkey=mkey)
...
def fortios_system(data, fos, check_mode):
    ...
    fos.do_member_operation('system_automation_trigger')
