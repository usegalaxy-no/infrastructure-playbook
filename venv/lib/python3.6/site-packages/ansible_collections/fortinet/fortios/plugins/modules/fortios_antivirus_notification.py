...
def fortios_antivirus(data, fos, check_mode):
    ...
    fos.do_member_operation('antivirus_notification')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["antivirus_notification"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["antivirus_notification"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "antivirus_notification")
