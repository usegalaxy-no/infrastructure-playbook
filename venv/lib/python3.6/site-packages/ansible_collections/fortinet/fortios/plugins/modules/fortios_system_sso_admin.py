...
def system_sso_admin(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('system', 'sso_admin', filtered_data, vdom=vdom)
        current_data = fos.get('system', 'sso_admin', vdom=vdom, mkey=mkey)
...
def fortios_system(data, fos, check_mode):
    ...
    fos.do_member_operation('system_sso_admin')
