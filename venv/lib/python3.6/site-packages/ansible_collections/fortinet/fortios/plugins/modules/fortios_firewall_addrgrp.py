...
def filter_firewall_addrgrp_data(json):
    option_list = ['allow_routing', 'category', 'color',
                   'comment', 'exclude', 'exclude_member',
                   'fabric_object', 'member', 'name',
                   'tagging', 'type', 'uuid',
                   'visibility']
    dictionary = {}
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_addrgrp')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["firewall_addrgrp"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "firewall_addrgrp")
