...
def fortios_log(data, fos):
    ...
    fos.do_member_operation('log_threat_weight')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["log_threat_weight"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "log_threat_weight")
