...
def fortios_system(data, fos):
    ...
    fos.do_member_operation('system_network_visibility')
    if data['system_network_visibility']:
        resp = system_network_visibility(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('system_network_visibility'))
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_network_visibility"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["system_network_visibility"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_network_visibility")
