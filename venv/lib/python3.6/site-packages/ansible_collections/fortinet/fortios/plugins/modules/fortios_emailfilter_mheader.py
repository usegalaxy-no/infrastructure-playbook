...
- collections:
  ...
  vars:
    ...
    vdom: root
  tasks:
  - name: fortios_emailfilter_mheader
    fortios_emailfilter_mheader:
      vdom: root
      state: present
      emailfilter_mheader:
        id: 1
        name: terr-emfilter-mheader
...
def emailfilter_mheader(data, fos, check_mode=False):
    ...
    filtered_data = underscore_to_hyphen(filter_emailfilter_mheader_data(emailfilter_mheader_data))
...
def fortios_emailfilter(data, fos, check_mode):
    ...
    fos.do_member_operation('emailfilter_mheader')
