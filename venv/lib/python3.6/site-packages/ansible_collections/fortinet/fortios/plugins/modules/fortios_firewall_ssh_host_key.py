...
def firewall_ssh_host_key(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('firewall_ssh', 'host_key', filtered_data, vdom=vdom)
        current_data = fos.get('firewall_ssh', 'host_key', vdom=vdom, mkey=mkey)
...
def fortios_firewall_ssh(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_ssh_host_key')
