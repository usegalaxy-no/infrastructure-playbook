...
def filter_system_dns_data(json):
    option_list = ['alt_primary', 'alt_secondary', 'cache_notfound_responses',
                   'dns_cache_limit', 'dns_cache_ttl', 'dns_over_tls',
                   'domain', 'interface', 'interface_select_method',
                   'ip6_primary', 'ip6_secondary', 'log',
                   'primary', 'protocol', 'retry',
                   'secondary', 'server_hostname', 'server_select_method',
                   'source_ip', 'ssl_certificate', 'timeout']
    dictionary = {}
