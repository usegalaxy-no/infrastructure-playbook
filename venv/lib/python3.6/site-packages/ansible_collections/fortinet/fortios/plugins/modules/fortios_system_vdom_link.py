...
def system_vdom_link(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('system', 'vdom_link', filtered_data, vdom=vdom)
        current_data = fos.get('system', 'vdom_link', vdom=vdom, mkey=mkey)
...
def fortios_system(data, fos, check_mode):
    ...
    fos.do_member_operation('system_vdom_link')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_vdom_link"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_vdom_link")
