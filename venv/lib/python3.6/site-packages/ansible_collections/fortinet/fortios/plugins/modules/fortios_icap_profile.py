...
def filter_icap_profile_data(json):
    option_list = ['icap_block_log', 'icap_headers', 'methods',
                   'name', 'preview', 'preview_data_length',
                   'replacemsg_group', 'request', 'request_failure',
                   'request_path', 'request_server', 'respmod_default_action',
                   'respmod_forward_rules', 'response', 'response_failure',
...
def fortios_icap(data, fos, check_mode):
    ...
    fos.do_member_operation('icap_profile')
