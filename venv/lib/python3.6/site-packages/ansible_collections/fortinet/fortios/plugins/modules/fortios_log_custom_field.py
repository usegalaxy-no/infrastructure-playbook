...
def log_custom_field(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('log', 'custom_field', filtered_data, vdom=vdom)
        current_data = fos.get('log', 'custom_field', vdom=vdom, mkey=mkey)
...
def main():
    ...
    if module._socket_path:
        ...
        is_error, has_changed, result = fortios_log(module.params, fos, module.check_mode)
