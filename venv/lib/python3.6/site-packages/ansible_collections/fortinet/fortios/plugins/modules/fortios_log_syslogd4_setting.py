...
def fortios_log_syslogd4(data, fos):
    ...
    fos.do_member_operation('log_syslogd4_setting')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["log_syslogd4_setting"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "log_syslogd4_setting")
