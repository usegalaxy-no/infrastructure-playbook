...
def filter_user_quarantine_data(json):
    option_list = ['firewall_groups', 'quarantine', 'targets',
                   'traffic_policy']
    dictionary = {}
...
def fortios_user(data, fos):
    ...
    fos.do_member_operation('user_quarantine')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["user_quarantine"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "user_quarantine")
