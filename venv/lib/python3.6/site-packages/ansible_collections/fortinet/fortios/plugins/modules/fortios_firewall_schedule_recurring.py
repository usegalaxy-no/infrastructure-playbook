...
def firewall_schedule_recurring(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('firewall_schedule', 'recurring', filtered_data, vdom=vdom)
        current_data = fos.get('firewall_schedule', 'recurring', vdom=vdom, mkey=mkey)
...
def fortios_firewall_schedule(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_schedule_recurring')
