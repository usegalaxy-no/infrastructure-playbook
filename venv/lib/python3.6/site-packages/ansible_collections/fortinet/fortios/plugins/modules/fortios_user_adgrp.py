...
def filter_user_adgrp_data(json):
    option_list = ['connector_source', 'id', 'name',
                   'server_name']
    dictionary = {}
...
def fortios_user(data, fos, check_mode):
    ...
    fos.do_member_operation('user_adgrp')
    if data['user_adgrp']:
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["user_adgrp"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "user_adgrp")
