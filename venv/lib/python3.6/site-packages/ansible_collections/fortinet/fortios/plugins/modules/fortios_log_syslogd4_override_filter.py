...
- collections:
  ...
  vars:
    ...
    vdom: root
  tasks:
  - name: fortios_log_syslogd4_override_filter
...
def fortios_log_syslogd4(data, fos):
    ...
    fos.do_member_operation('log_syslogd4_override_filter')
    if data['log_syslogd4_override_filter']:
        resp = log_syslogd4_override_filter(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('log_syslogd4_override_filter'))
