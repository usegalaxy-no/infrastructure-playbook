...
def fortios_system(data, fos):
    ...
    fos.do_member_operation('system_affinity_packet_redistribution')
    if data['system_affinity_packet_redistribution']:
        resp = system_affinity_packet_redistribution(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('system_affinity_packet_redistribution'))
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_affinity_packet_redistribution"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["system_affinity_packet_redistribution"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_affinity_packet_redistribution")
