  ...
  - name: fortios_system_fortiguard
    fortios_system_fortiguard:
      ...
      system_fortiguard:
        ...
        antispam_expiration: 1557273600
        ...
        source_ip: 0.0.0.0
        source_ip6: '::'
        update_server_location: any
        webfilter_cache: enable
        webfilter_cache_ttl: 3600
        webfilter_expiration: 1557273600
...
def filter_system_fortiguard_data(json):
    option_list = ['antispam_cache', 'antispam_cache_mpercent', 'antispam_cache_ttl',
                   ...
                   'auto_join_forticloud', 'ddns_server_ip', 'ddns_server_ip6',
                   'ddns_server_port', 'fortiguard_anycast', 'fortiguard_anycast_source',
                   'interface', 'interface_select_method', 'load_balance_servers',
                   'outbreak_prevention_cache', 'outbreak_prevention_cache_mpercent', 'outbreak_prevention_cache_ttl',
                   'outbreak_prevention_expiration', 'outbreak_prevention_force_off', 'outbreak_prevention_license',
                   'outbreak_prevention_timeout', 'persistent_connection', 'port',
                   ...
                   'update_build_proxy', 'update_extdb', 'update_ffdb',
                   'update_server_location', 'update_uwdb', 'videofilter_expiration',
                   'videofilter_license', 'webfilter_cache', 'webfilter_cache_ttl',
