...
- collections:
  ...
  vars:
    ...
    vdom: root
  tasks:
  - name: fortios_log_syslogd3_override_setting
...
def fortios_log_syslogd3(data, fos):
    ...
    fos.do_member_operation('log_syslogd3_override_setting')
    if data['log_syslogd3_override_setting']:
        resp = log_syslogd3_override_setting(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('log_syslogd3_override_setting'))
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["log_syslogd3_override_setting"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["log_syslogd3_override_setting"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "log_syslogd3_override_setting")
