...
def filter_wireless_controller_timers_data(json):
    option_list = ['ble_scan_report_intv', 'client_idle_timeout', 'darrp_day',
                   ...
                   'drma_interval', 'echo_interval', 'fake_ap_log',
                   'ipsec_intf_cleanup', 'radio_stats_interval', 'rogue_ap_log',
                   'sta_capability_interval', 'sta_locate_timer', 'sta_stats_interval',
                   'vap_stats_interval']
    dictionary = {}
...
def fortios_wireless_controller(data, fos):
    ...
    fos.do_member_operation('wireless_controller_timers')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["wireless_controller_timers"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["wireless_controller_timers"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "wireless_controller_timers")
