...
def filter_switch_controller_nac_device_data(json):
    option_list = ['description', 'id', 'last_known_port',
                   'last_known_switch', 'last_seen', 'mac',
                   'mac_policy', 'matched_nac_policy', 'port_policy',
                   'status']
    dictionary = {}
...
def switch_controller_nac_device(data, fos):
    ...
    filtered_data = underscore_to_hyphen(filter_switch_controller_nac_device_data(switch_controller_nac_device_data))
...
def fortios_switch_controller(data, fos):
    ...
    fos.do_member_operation('switch_controller_nac_device')
    if data['switch_controller_nac_device']:
        resp = switch_controller_nac_device(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('switch_controller_nac_device'))
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["switch_controller_nac_device"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["switch_controller_nac_device"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "switch_controller_nac_device")
