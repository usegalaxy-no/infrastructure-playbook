...
def firewall_dos_policy(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('firewall', 'dos_policy', filtered_data, vdom=vdom)
        current_data = fos.get('firewall', 'dos_policy', vdom=vdom, mkey=mkey)
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_dos_policy')
