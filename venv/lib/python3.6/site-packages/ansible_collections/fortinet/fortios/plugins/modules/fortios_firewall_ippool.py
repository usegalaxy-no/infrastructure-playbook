...
def filter_firewall_ippool_data(json):
    option_list = ['add_nat64_route', 'arp_intf', 'arp_reply',
                   'associated_interface', 'block_size', 'comments',
                   'endip', 'endport', 'name',
                   'nat64', 'num_blocks_per_user', 'pba_timeout',
                   'permit_any_host', 'port_per_user', 'source_endip',
                   'source_startip', 'startip', 'startport',
                   'type']
    dictionary = {}
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_ippool')
