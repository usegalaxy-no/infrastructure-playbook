...
def fortios_dlp(data, fos, check_mode):
    ...
    fos.do_member_operation('dlp_filepattern')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["dlp_filepattern"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "dlp_filepattern")
