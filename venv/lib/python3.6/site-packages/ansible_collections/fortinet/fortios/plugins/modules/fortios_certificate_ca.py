...
def fortios_certificate(data, fos, check_mode):
    ...
    fos.do_member_operation('certificate_ca')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["certificate_ca"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "certificate_ca")
