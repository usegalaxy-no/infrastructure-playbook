...
- collections:
  ...
  vars:
    ...
    vdom: root
  tasks:
  - name: fortios_emailfilter_options
...
def fortios_emailfilter(data, fos):
    ...
    fos.do_member_operation('emailfilter_options')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["emailfilter_options"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "emailfilter_options")
