...
def fortios_webfilter(data, fos):
    ...
    fos.do_member_operation('webfilter_ips_urlfilter_setting')
    if data['webfilter_ips_urlfilter_setting']:
        resp = webfilter_ips_urlfilter_setting(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('webfilter_ips_urlfilter_setting'))
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["webfilter_ips_urlfilter_setting"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["webfilter_ips_urlfilter_setting"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "webfilter_ips_urlfilter_setting")
