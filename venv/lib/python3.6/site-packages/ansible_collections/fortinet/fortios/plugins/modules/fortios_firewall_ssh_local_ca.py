  ...
  - name: fortios_firewall_ssh_local_ca
    fortios_firewall_ssh_local_ca:
      ...
      firewall_ssh_local_ca:
        ...
        private_key: terr-test-rdmstr
        public_key: terr-test-rdmstr
        source: user
...
def firewall_ssh_local_ca(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('firewall_ssh', 'local_ca', filtered_data, vdom=vdom)
        current_data = fos.get('firewall_ssh', 'local_ca', vdom=vdom, mkey=mkey)
...
def fortios_firewall_ssh(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_ssh_local_ca')
...
def main():
    ...
    if module._socket_path:
        ...
        is_error, has_changed, result = fortios_firewall_ssh(module.params, fos, module.check_mode)
