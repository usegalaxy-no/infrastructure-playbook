...
def fortios_antivirus(data, fos):
    ...
    fos.do_member_operation('antivirus_heuristic')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["antivirus_heuristic"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "antivirus_heuristic")
