      ...
      firewall_internet_service_custom:
        ...
        - dst:
          ...
          - end_port: 5
            ...
            start_port: 1
          protocol: 33
        name: terr-firw-intnetsevcustom
        reputation: 3
...
def filter_firewall_internet_service_custom_data(json):
    option_list = ['comment', 'disable_entry', 'entry',
                   'master_service_id', 'name', 'reputation']
    dictionary = {}
...
def firewall_internet_service_custom(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('firewall', 'internet_service_custom', filtered_data, vdom=vdom)
        current_data = fos.get('firewall', 'internet_service_custom', vdom=vdom, mkey=mkey)
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_internet_service_custom')
