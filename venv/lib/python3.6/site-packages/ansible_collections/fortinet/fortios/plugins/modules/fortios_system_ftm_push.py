...
def filter_system_ftm_push_data(json):
    option_list = ['server', 'server_cert', 'server_ip',
                   'server_port', 'status']
    dictionary = {}
...
def fortios_system(data, fos):
    ...
    fos.do_member_operation('system_ftm_push')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_ftm_push"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_ftm_push")
