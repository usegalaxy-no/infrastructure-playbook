...
def fortios_router(data, fos):
    ...
    fos.do_member_operation('router_multicast6')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["router_multicast6"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "router_multicast6")
