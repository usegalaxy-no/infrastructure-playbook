...
def fortios_firewall_ssl(data, fos):
    ...
    fos.do_member_operation('firewall_ssl_setting')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["firewall_ssl_setting"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "firewall_ssl_setting")
