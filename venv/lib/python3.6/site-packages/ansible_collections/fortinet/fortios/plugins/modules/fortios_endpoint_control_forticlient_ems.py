...
def endpoint_control_forticlient_ems(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('endpoint_control', 'forticlient_ems', filtered_data, vdom=vdom)
        current_data = fos.get('endpoint_control', 'forticlient_ems', vdom=vdom, mkey=mkey)
...
def fortios_endpoint_control(data, fos, check_mode):
    ...
    fos.do_member_operation('endpoint_control_forticlient_ems')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["endpoint_control_forticlient_ems"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["endpoint_control_forticlient_ems"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "endpoint_control_forticlient_ems")
