...
def vpn_ipsec_phase2_interface(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('vpn_ipsec', 'phase2_interface', filtered_data, vdom=vdom)
        current_data = fos.get('vpn_ipsec', 'phase2_interface', vdom=vdom, mkey=mkey)
...
def fortios_vpn_ipsec(data, fos, check_mode):
    ...
    fos.do_member_operation('vpn_ipsec_phase2_interface')
