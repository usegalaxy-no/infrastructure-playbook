...
def filter_authentication_rule_data(json):
    option_list = ['active_auth_method', 'comments', 'dstaddr',
                   'dstaddr6', 'ip_based', 'name',
                   'protocol', 'srcaddr', 'srcaddr6',
                   'srcintf', 'sso_auth_method', 'status',
...
def fortios_authentication(data, fos, check_mode):
    ...
    fos.do_member_operation('authentication_rule')
