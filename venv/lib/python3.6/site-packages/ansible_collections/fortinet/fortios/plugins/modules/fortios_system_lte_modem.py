...
def filter_system_lte_modem_data(json):
    option_list = ['apn', 'authtype', 'extra_init',
                   'holddown_timer', 'interface', 'mode',
                   'modem_port', 'passwd', 'status',
                   'username']
    dictionary = {}
...
def fortios_system(data, fos):
    ...
    fos.do_member_operation('system_lte_modem')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_lte_modem"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_lte_modem")
