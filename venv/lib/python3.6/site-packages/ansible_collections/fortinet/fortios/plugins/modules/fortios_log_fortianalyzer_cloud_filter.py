...
- collections:
  ...
  vars:
    ...
    vdom: root
  tasks:
  - name: fortios_log_fortianalyzer_cloud_filter
...
def fortios_log_fortianalyzer_cloud(data, fos):
    ...
    fos.do_member_operation('log_fortianalyzer_cloud_filter')
    if data['log_fortianalyzer_cloud_filter']:
        resp = log_fortianalyzer_cloud_filter(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('log_fortianalyzer_cloud_filter'))
