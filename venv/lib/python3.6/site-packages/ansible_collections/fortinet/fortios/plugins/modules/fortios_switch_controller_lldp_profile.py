...
def switch_controller_lldp_profile(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('switch_controller', 'lldp_profile', filtered_data, vdom=vdom)
        current_data = fos.get('switch_controller', 'lldp_profile', vdom=vdom, mkey=mkey)
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    fos.do_member_operation('switch_controller_lldp_profile')
