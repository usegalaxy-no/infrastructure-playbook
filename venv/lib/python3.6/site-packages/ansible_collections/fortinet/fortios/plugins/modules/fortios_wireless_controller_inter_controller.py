...
def fortios_wireless_controller(data, fos):
    ...
    fos.do_member_operation('wireless_controller_inter_controller')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["wireless_controller_inter_controller"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["wireless_controller_inter_controller"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "wireless_controller_inter_controller")
