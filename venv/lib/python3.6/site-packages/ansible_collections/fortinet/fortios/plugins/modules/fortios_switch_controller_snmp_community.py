...
def switch_controller_snmp_community(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('switch_controller', 'snmp_community', filtered_data, vdom=vdom)
        current_data = fos.get('switch_controller', 'snmp_community', vdom=vdom, mkey=mkey)
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    fos.do_member_operation('switch_controller_snmp_community')
