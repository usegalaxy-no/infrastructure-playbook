...
def filter_system_email_server_data(json):
    option_list = ['authenticate', 'interface', 'interface_select_method',
                   'password', 'port', 'reply_to',
                   'security', 'server', 'source_ip',
                   'source_ip6', 'ssl_min_proto_version', 'type',
...
def fortios_system(data, fos):
    ...
    fos.do_member_operation('system_email_server')
