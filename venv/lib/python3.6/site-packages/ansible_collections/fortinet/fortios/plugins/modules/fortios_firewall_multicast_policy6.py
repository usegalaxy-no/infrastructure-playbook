...
def firewall_multicast_policy6(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('firewall', 'multicast_policy6', filtered_data, vdom=vdom)
        current_data = fos.get('firewall', 'multicast_policy6', vdom=vdom, mkey=mkey)
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_multicast_policy6')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["firewall_multicast_policy6"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_multicast_policy6"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "firewall_multicast_policy6")
