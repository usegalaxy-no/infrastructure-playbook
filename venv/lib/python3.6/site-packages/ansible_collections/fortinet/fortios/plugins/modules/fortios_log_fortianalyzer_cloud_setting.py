...
def filter_log_fortianalyzer_cloud_setting_data(json):
    option_list = ['__change_ip', 'access_config', 'certificate',
                   ...
                   'hmac_algorithm', 'interface', 'interface_select_method',
                   'ips_archive', 'max_log_rate', 'mgmt_name',
                   'monitor_failure_retry_period', 'monitor_keepalive_period', 'preshared_key',
...
def fortios_log_fortianalyzer_cloud(data, fos):
    ...
    fos.do_member_operation('log_fortianalyzer_cloud_setting')
