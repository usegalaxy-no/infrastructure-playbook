...
- collections:
  ...
  vars:
    ...
    vdom: root
  tasks:
  - name: fortios_emailfilter_fortishield
...
def fortios_emailfilter(data, fos):
    ...
    fos.do_member_operation('emailfilter_fortishield')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["emailfilter_fortishield"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["emailfilter_fortishield"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "emailfilter_fortishield")
