...
def filter_gtp_rat_timeout_profile_data(json):
    option_list = ['eutran_timeout', 'gan_timeout', 'geran_timeout',
                   'hspa_timeout', 'ltem_timeout', 'name',
                   'nbiot_timeout', 'nr_timeout', 'utran_timeout',
                   'virtual_timeout', 'wlan_timeout']
    dictionary = {}
...
def fortios_gtp(data, fos):
    ...
    fos.do_member_operation('gtp_rat_timeout_profile')
