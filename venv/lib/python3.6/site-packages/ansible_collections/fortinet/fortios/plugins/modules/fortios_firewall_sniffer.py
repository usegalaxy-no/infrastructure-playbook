...
def filter_firewall_sniffer_data(json):
    option_list = ['anomaly', 'application_list', 'application_list_status',
                   ...
                   'emailfilter_profile_status', 'file_filter_profile', 'file_filter_profile_status',
                   'host', 'id', 'interface',
                   'ip_threatfeed', 'ip_threatfeed_status', 'ips_dos_status',
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_sniffer')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["firewall_sniffer"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "firewall_sniffer")
