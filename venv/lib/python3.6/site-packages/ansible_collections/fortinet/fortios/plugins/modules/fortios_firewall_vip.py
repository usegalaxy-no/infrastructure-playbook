...
def filter_firewall_vip_data(json):
    option_list = ['add_nat46_route', 'arp_reply', 'color',
                   'comment', 'dns_mapping_ttl', 'extaddr',
                   'extintf', 'extip', 'extport',
                   'gratuitous_arp_interval', 'http_cookie_age', 'http_cookie_domain',
                   ...
                   'id', 'ipv6_mappedip', 'ipv6_mappedport',
                   'ldb_method', 'mapped_addr', 'mappedip',
                   'mappedport', 'max_embryonic_connections', 'monitor',
                   'name', 'nat_source_vip', 'nat44',
                   'nat46', 'outlook_web_access', 'persistence',
                   ...
                   'ssl_client_rekey_count', 'ssl_client_renegotiation', 'ssl_client_session_state_max',
                   'ssl_client_session_state_timeout', 'ssl_client_session_state_type', 'ssl_dh_bits',
                   'ssl_hpkp', 'ssl_hpkp_age', 'ssl_hpkp_backup',
                   'ssl_hpkp_include_subdomains', 'ssl_hpkp_primary', 'ssl_hpkp_report_uri',
                   'ssl_hsts', 'ssl_hsts_age', 'ssl_hsts_include_subdomains',
                   'ssl_http_location_conversion', 'ssl_http_match_host', 'ssl_max_version',
                   'ssl_min_version', 'ssl_mode', 'ssl_pfs',
                   'ssl_send_empty_frags', 'ssl_server_algorithm', 'ssl_server_cipher_suites',
                   'ssl_server_max_version', 'ssl_server_min_version', 'ssl_server_session_state_max',
                   'ssl_server_session_state_timeout', 'ssl_server_session_state_type', 'status',
                   'type', 'uuid', 'weblogic_server',
                   'websphere_server']
    dictionary = {}
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_vip')
