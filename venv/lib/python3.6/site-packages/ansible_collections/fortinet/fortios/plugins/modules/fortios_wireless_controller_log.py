...
- collections:
  ...
  vars:
    ...
    vdom: root
  tasks:
  - name: fortios_wireless_controller_log
    fortios_wireless_controller_log:
      vdom: root
      wireless_controller_log:
        addrgrp_log: notification
        ble_log: notification
        clb_log: notification
        dhcp_starv_log: notification
        led_sched_log: notification
        radio_event_log: notification
        rogue_event_log: notification
        sta_event_log: notification
        sta_locate_log: notification
        status: enable
        wids_log: notification
        wtp_event_log: notification
...
def fortios_wireless_controller(data, fos):
    ...
    fos.do_member_operation('wireless_controller_log')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["wireless_controller_log"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["wireless_controller_log"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "wireless_controller_log")
