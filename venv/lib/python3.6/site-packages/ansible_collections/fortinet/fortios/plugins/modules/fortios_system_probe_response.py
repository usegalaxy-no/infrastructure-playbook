...
def fortios_system(data, fos):
    ...
    fos.do_member_operation('system_probe_response')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_probe_response"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["system_probe_response"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_probe_response")
