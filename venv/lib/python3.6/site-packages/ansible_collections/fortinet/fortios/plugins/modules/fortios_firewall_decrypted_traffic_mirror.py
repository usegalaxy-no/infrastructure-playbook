...
- collections:
  ...
  vars:
    ...
    vdom: root
  tasks:
  - name: fortios_firewall_decrypted_traffic_mirror
...
def firewall_decrypted_traffic_mirror(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('firewall', 'decrypted_traffic_mirror', filtered_data, vdom=vdom)
        current_data = fos.get('firewall', 'decrypted_traffic_mirror', vdom=vdom, mkey=mkey)
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_decrypted_traffic_mirror')
