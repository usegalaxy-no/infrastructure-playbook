...
def firewall_profile_protocol_options(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('firewall', 'profile_protocol_options', filtered_data, vdom=vdom)
        current_data = fos.get('firewall', 'profile_protocol_options', vdom=vdom, mkey=mkey)
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_profile_protocol_options')
