...
- collections:
  ...
  - name: fortios_user_fortitoken
    fortios_user_fortitoken:
      ...
      user_fortitoken:
        activation_expire: 0
        license: FTMTRIAL0B6C17E4
        serial_number: FTKMOB0970127FE2
        status: active
...
def fortios_user(data, fos, check_mode):
    ...
    fos.do_member_operation('user_fortitoken')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["user_fortitoken"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "user_fortitoken")
