...
def fortios_application(data, fos, check_mode):
    ...
    fos.do_member_operation('application_custom')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["application_custom"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "application_custom")
