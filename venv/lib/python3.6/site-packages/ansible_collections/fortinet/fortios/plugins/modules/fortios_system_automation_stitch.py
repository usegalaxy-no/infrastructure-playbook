...
def filter_system_automation_stitch_data(json):
    option_list = ['action', 'actions', 'description',
...
def system_automation_stitch(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('system', 'automation_stitch', filtered_data, vdom=vdom)
        current_data = fos.get('system', 'automation_stitch', vdom=vdom, mkey=mkey)
...
def fortios_system(data, fos, check_mode):
    ...
    fos.do_member_operation('system_automation_stitch')
