...
def filter_system_ddns_data(json):
    option_list = ['addr_type', 'bound_ip', 'clear_text',
                   'ddns_auth', 'ddns_domain', 'ddns_key',
                   'ddns_keyname', 'ddns_password', 'ddns_server',
                   'ddns_server_addr', 'ddns_server_ip', 'ddns_sn',
                   'ddns_ttl', 'ddns_username', 'ddns_zone',
                   'ddnsid', 'monitor_interface', 'server_type',
...
def fortios_system(data, fos, check_mode):
    ...
    fos.do_member_operation('system_ddns')
    if data['system_ddns']:
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_ddns"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_ddns")
