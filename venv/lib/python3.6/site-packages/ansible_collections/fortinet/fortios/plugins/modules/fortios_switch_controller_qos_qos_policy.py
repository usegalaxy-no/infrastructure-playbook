...
- collections:
  ...
  vars:
    ...
    vdom: root
  tasks:
  - name: fortios_switch_controller_qos_qos_policy
    fortios_switch_controller_qos_qos_policy:
      ...
      switch_controller_qos_qos_policy:
        ...
        trust_dot1p_map: voice-dot1p
        trust_ip_dscp_map: voice-dscp
...
def switch_controller_qos_qos_policy(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('switch_controller_qos', 'qos_policy', filtered_data, vdom=vdom)
        current_data = fos.get('switch_controller_qos', 'qos_policy', vdom=vdom, mkey=mkey)
...
def fortios_switch_controller_qos(data, fos, check_mode):
    ...
    fos.do_member_operation('switch_controller_qos_qos_policy')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["switch_controller_qos_qos_policy"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["switch_controller_qos_qos_policy"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "switch_controller_qos_qos_policy")
