...
def firewall_security_policy(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('firewall', 'security_policy', filtered_data, vdom=vdom)
        current_data = fos.get('firewall', 'security_policy', vdom=vdom, mkey=mkey)
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_security_policy')
