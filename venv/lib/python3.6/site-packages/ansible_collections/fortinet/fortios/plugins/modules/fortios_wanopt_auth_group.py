...
def wanopt_auth_group(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('wanopt', 'auth_group', filtered_data, vdom=vdom)
        current_data = fos.get('wanopt', 'auth_group', vdom=vdom, mkey=mkey)
...
def fortios_wanopt(data, fos, check_mode):
    ...
    fos.do_member_operation('wanopt_auth_group')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["wanopt_auth_group"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "wanopt_auth_group")
