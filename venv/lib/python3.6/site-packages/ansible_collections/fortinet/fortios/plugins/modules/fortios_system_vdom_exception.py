...
def system_vdom_exception(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('system', 'vdom_exception', filtered_data, vdom=vdom)
        current_data = fos.get('system', 'vdom_exception', vdom=vdom, mkey=mkey)
...
def fortios_system(data, fos, check_mode):
    ...
    fos.do_member_operation('system_vdom_exception')
