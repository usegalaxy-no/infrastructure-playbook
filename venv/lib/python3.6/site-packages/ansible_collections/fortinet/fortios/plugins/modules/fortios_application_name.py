...
def filter_application_name_data(json):
    option_list = ['behavior', 'category', 'id',
                   ...
                   'parameters', 'popularity', 'protocol',
                   'risk', 'sub_category', 'technology',
                   'vendor', 'weight']
    dictionary = {}
...
def fortios_application(data, fos, check_mode):
    ...
    fos.do_member_operation('application_name')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["application_name"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "application_name")
