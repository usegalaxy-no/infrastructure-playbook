...
def filter_system_fortisandbox_data(json):
    option_list = ['email', 'enc_algorithm', 'forticloud',
                   'interface', 'interface_select_method', 'server',
...
def fortios_system(data, fos):
    ...
    fos.do_member_operation('system_fortisandbox')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_fortisandbox"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_fortisandbox")
