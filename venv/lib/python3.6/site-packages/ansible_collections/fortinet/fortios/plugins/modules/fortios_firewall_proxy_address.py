...
def firewall_proxy_address(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('firewall', 'proxy_address', filtered_data, vdom=vdom)
        current_data = fos.get('firewall', 'proxy_address', vdom=vdom, mkey=mkey)
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_proxy_address')
