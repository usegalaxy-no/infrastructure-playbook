...
def filter_system_stp_data(json):
    option_list = ['config_revision', 'forward_delay', 'hello_time',
                   'max_age', 'max_hops', 'region_name',
                   'status', 'switch_priority']
    dictionary = {}
...
def fortios_system(data, fos):
    ...
    fos.do_member_operation('system_stp')
    if data['system_stp']:
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_stp"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_stp")
