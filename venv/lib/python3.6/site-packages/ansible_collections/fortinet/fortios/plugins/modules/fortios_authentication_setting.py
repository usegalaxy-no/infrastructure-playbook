...
def filter_authentication_setting_data(json):
    option_list = ['active_auth_scheme', 'auth_https', 'captive_portal',
                   ...
                   'cert_auth', 'cert_captive_portal', 'cert_captive_portal_ip',
                   'cert_captive_portal_port', 'dev_range', 'sso_auth_scheme',
                   'user_cert_ca']
    dictionary = {}
...
def fortios_authentication(data, fos):
    ...
    fos.do_member_operation('authentication_setting')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["authentication_setting"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["authentication_setting"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "authentication_setting")
