...
def fortios_report(data, fos, check_mode):
    ...
    fos.do_member_operation('report_dataset')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["report_dataset"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "report_dataset")
