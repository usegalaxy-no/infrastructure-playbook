...
def fortios_firewall_ipmacbinding(data, fos):
    ...
    fos.do_member_operation('firewall_ipmacbinding_setting')
    if data['firewall_ipmacbinding_setting']:
        resp = firewall_ipmacbinding_setting(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('firewall_ipmacbinding_setting'))
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["firewall_ipmacbinding_setting"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_ipmacbinding_setting"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "firewall_ipmacbinding_setting")
