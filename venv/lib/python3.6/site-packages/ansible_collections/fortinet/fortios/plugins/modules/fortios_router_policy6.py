...
def fortios_router(data, fos, check_mode):
    ...
    fos.do_member_operation('router_policy6')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["router_policy6"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "router_policy6")

        is_error, has_changed, result = fortios_router(module.params, fos, module.check_mode)
