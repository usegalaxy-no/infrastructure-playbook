  ...
  - name: fortios_system_api_user
    fortios_system_api_user:
      ...
      system_api_user:
        ...
        name: terr-test-apiuser
        peer_auth: disable
        trusthost:
        - id: 1
          ipv4_trusthost: 10.100.0.0 255.255.0.0
          type: ipv4-trusthost
        vdom:
        - name: root
...
def system_api_user(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('system', 'api_user', filtered_data, vdom=vdom)
        current_data = fos.get('system', 'api_user', vdom=vdom, mkey=mkey)
...
def fortios_system(data, fos, check_mode):
    ...
    fos.do_member_operation('system_api_user')
