...
def filter_system_netflow_data(json):
    option_list = ['active_flow_timeout', 'collector_ip', 'collector_port',
                   'inactive_flow_timeout', 'interface', 'interface_select_method',
                   'source_ip', 'template_tx_counter', 'template_tx_timeout']
    dictionary = {}
...
def fortios_system(data, fos):
    ...
    fos.do_member_operation('system_netflow')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_netflow"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_netflow")
