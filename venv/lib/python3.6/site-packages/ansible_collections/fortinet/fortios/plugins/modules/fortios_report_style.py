...
def fortios_report(data, fos, check_mode):
    ...
    fos.do_member_operation('report_style')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["report_style"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "report_style")
