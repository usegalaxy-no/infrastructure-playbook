...
def filter_vpn_ssl_settings_data(json):
    option_list = ['algorithm', 'auth_session_check_source_ip', 'auth_timeout',
                   ...
                   'saml_redirect_port', 'servercert', 'source_address',
                   ...
                   'ssl_max_proto_ver', 'ssl_min_proto_ver', 'status',
                   'tlsv1_0', 'tlsv1_1', 'tlsv1_2',
                   'tlsv1_3', 'transform_backward_slashes', 'tunnel_addr_assigned_method',
...
def fortios_vpn_ssl(data, fos):
    ...
    fos.do_member_operation('vpn_ssl_settings')
