...
def system_gre_tunnel(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('system', 'gre_tunnel', filtered_data, vdom=vdom)
        current_data = fos.get('system', 'gre_tunnel', vdom=vdom, mkey=mkey)
...
def fortios_system(data, fos, check_mode):
    ...
    fos.do_member_operation('system_gre_tunnel')
