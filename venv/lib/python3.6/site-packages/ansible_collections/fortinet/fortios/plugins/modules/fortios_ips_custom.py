...
def fortios_ips(data, fos, check_mode):
    ...
    fos.do_member_operation('ips_custom')
    if data['ips_custom']:
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["ips_custom"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "ips_custom")
