        ...
        suboptions:
            ...
            hpe:
                ...
                suboptions:
                    ...
                    pri_type_max:
                        description:
                            - 'Maximum overflow rate of priority type traffic(10K - 4G pps). Includes L2: HA, 802.3ad LACP, heartbeats. L3: OSPF. L4_TCP: BGP.
                               L4_UDP: IKE, SLBC, BFD.'
                        type: int
                    sctp_max:
                        description:
...
def filter_system_np6_data(json):
    option_list = ['fastpath', 'fp_anomaly', 'garbage_session_collector',
                   'hpe', 'ipsec_ob_hash_function', 'ipsec_outbound_hash',
                   'low_latency_mode', 'name', 'per_session_accounting',
                   'session_collector_interval', 'session_timeout_fixed', 'session_timeout_interval',
                   'session_timeout_random_range']
    dictionary = {}
...
def fortios_system(data, fos, check_mode):
    ...
    fos.do_member_operation('system_np6')
    if data['system_np6']:
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_np6"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_np6")
