  ...
  - name: fortios_alertemail_setting
    fortios_alertemail_setting:
      ...
      alertemail_setting:
        ...
        fds_license_expiring_warning: disable
        fds_update_logs: disable
        filter_mode: category
        fips_cc_errors: disable
        firewall_authentication_failure_logs: disable
        fortiguard_log_quota_warning: disable
        ...
        local_disk_usage: 75
        log_disk_usage_warning: disable
        mailto1: test@example.com
        ...
        violation_traffic_logs: disable
        warning_interval: 10
        webfilter_logs: disable
