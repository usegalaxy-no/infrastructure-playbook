...
def fortios_ips(data, fos):
    ...
    fos.do_member_operation('ips_settings')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["ips_settings"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "ips_settings")
