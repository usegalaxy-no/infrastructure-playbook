  ...
  - name: fortios_system_interface
    fortios_system_interface:
      ...
      system_interface:
        ...
        fortilink_neighbor_detect: fortilink
        ...
        ident_accept: disable
        idle_timeout: 0
        inbandwidth: 0
        ingress_spillover_threshold: 0
        internal: 0
        ip: 3.3.3.1 255.255.255.0
        ip_managed_by_fortiipam: disable
        ipmac: disable
        ips_sniffer_mode: disable
        ...
        pptp_auth_type: auto
        pptp_client: disable
        pptp_server_ip: 0.0.0.0
        pptp_timeout: 0
        preserve_session_route: disable
        priority: 0
        priority_override: enable
        proxy_captive_portal: disable
        ...
        security_mac_auth_bypass: disable
        security_mode: none
        ...
        subst: disable
        substitute_dst_mac: 00:00:00:00:00:00
        swc_first_create: 0
        swc_vlan: 0
        switch_controller_access_vlan: disable
        switch_controller_arp_inspection: disable
        switch_controller_dhcp_snooping: disable
        switch_controller_dhcp_snooping_option82: disable
        switch_controller_dhcp_snooping_verify_mac: disable
        switch_controller_feature: none
        switch_controller_igmp_snooping: disable
        switch_controller_igmp_snooping_fast_leave: disable
        switch_controller_igmp_snooping_proxy: disable
        switch_controller_iot_scanning: disable
        ...
        trust_ip6_2: ::/0
        trust_ip6_3: ::/0
        trust_ip_1: 0.0.0.0 0.0.0.0
        trust_ip_2: 0.0.0.0 0.0.0.0
        trust_ip_3: 0.0.0.0 0.0.0.0
        type: physical
        vdom: root
        vindex: 0
        vlan_protocol: 8021q
...
def filter_system_interface_data(json):
    option_list = ['ac_name', 'aggregate', 'algorithm',
                   ...
                   'device_user_identification', 'devindex', 'dhcp_classless_route_addition',
                   'dhcp_client_identifier', 'dhcp_relay_agent_option', 'dhcp_relay_interface',
                   'dhcp_relay_interface_select_method', 'dhcp_relay_ip', 'dhcp_relay_request_all_server',
                   'dhcp_relay_service', 'dhcp_relay_type', 'dhcp_renew_time',
                   'dhcp_snooping_server_list', 'disc_retry_timeout', 'disconnect_threshold',
                   'distance', 'dns_server_override', 'drop_fragment',
                   'drop_overlapped_fragment', 'egress_cos', 'egress_queues',
                   ...
                   'fortilink_neighbor_detect', 'fortilink_split_interface', 'fortilink_stacking',
                   'forward_domain', 'gi_gk', 'gwdetect',
                   'ha_priority', 'icmp_accept_redirect', 'icmp_send_redirect',
                   'ident_accept', 'idle_timeout', 'inbandwidth',
                   'ingress_cos', 'ingress_shaping_profile', 'ingress_spillover_threshold',
                   'interface', 'internal', 'ip',
                   'ip_managed_by_fortiipam', 'ipmac', 'ips_sniffer_mode',
                   'ipunnumbered', 'ipv6', 'l2forward',
                   'lacp_ha_slave', 'lacp_mode', 'lacp_speed',
                   'lcp_echo_interval', 'lcp_max_echo_fails', 'link_up_delay',
                   'lldp_network_policy', 'lldp_reception', 'lldp_transmission',
                   'macaddr', 'managed_device', 'managed_subnetwork_size',
                   'management_ip', 'measured_downstream_bandwidth', 'measured_upstream_bandwidth',
                   'mediatype', 'member', 'min_links',
                   ...
                   'scan_botnet_connections', 'secondary_IP', 'secondaryip',
                   'security_exempt_list', 'security_external_logout', 'security_external_web',
                   'security_groups', 'security_mac_auth_bypass', 'security_mode',
                   'security_redirect_url', 'service_name', 'sflow_sampler',
                   'snmp_index', 'speed', 'spillover_threshold',
                   'src_check', 'status', 'stp',
                   'stp_ha_secondary', 'stp_ha_slave', 'stpforward',
                   'stpforward_mode', 'subst', 'substitute_dst_mac',
                   'swc_first_create', 'swc_vlan', 'switch',
                   'switch_controller_access_vlan', 'switch_controller_arp_inspection', 'switch_controller_dhcp_snooping',
                   'switch_controller_dhcp_snooping_option82', 'switch_controller_dhcp_snooping_verify_mac', 'switch_controller_dynamic',
                   'switch_controller_feature', 'switch_controller_igmp_snooping', 'switch_controller_igmp_snooping_fast_leave',
                   'switch_controller_igmp_snooping_proxy', 'switch_controller_iot_scanning', 'switch_controller_learning_limit',
                   'switch_controller_mgmt_vlan', 'switch_controller_nac', 'switch_controller_rspan_mode',
                   'switch_controller_source_ip', 'switch_controller_traffic_policy', 'tagging',
                   'tcp_mss', 'trust_ip_1', 'trust_ip_2',
                   'trust_ip_3', 'trust_ip6_1', 'trust_ip6_2',
                   'trust_ip6_3', 'type', 'username',
                   'vdom', 'vindex', 'vlan_protocol',
...
def flatten_multilists_attributes(data):
    multilist_attrs = [
        [u'detectprotocol'],
        [u'ipv6', u'dhcp6_client_options'],
        [u'ipv6', u'ip6_allowaccess'],
        [u'fail_detect_option'],
        [u'allowaccess'],
        [u'secondaryip', u'detectprotocol'],
