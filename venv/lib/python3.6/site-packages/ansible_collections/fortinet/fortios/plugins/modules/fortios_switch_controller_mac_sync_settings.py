...
def fortios_switch_controller(data, fos):
    ...
    fos.do_member_operation('switch_controller_mac_sync_settings')
    if data['switch_controller_mac_sync_settings']:
        resp = switch_controller_mac_sync_settings(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('switch_controller_mac_sync_settings'))
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["switch_controller_mac_sync_settings"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["switch_controller_mac_sync_settings"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "switch_controller_mac_sync_settings")
