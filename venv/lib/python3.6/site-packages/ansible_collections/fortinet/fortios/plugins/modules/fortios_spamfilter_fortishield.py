...
def fortios_spamfilter(data, fos):
    ...
    fos.do_member_operation('spamfilter_fortishield')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["spamfilter_fortishield"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["spamfilter_fortishield"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "spamfilter_fortishield")
