...
def fortios_switch_controller(data, fos):
    ...
    fos.do_member_operation('switch_controller_storm_control')
    if data['switch_controller_storm_control']:
        resp = switch_controller_storm_control(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('switch_controller_storm_control'))
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["switch_controller_storm_control"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["switch_controller_storm_control"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "switch_controller_storm_control")
