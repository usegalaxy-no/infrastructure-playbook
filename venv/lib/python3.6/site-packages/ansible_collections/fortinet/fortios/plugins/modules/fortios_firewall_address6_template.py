...
- collections:
  ...
  - name: fortios_firewall_address6_template
    fortios_firewall_address6_template:
      ...
      state: present
      firewall_address6_template:
        ip6: 2001:11:11:11::/96
        name: terr-firw-addr6tem
...
def filter_firewall_address6_template_data(json):
    option_list = ['fabric_object', 'ip6', 'name',
                   'subnet_segment', 'subnet_segment_count']
    dictionary = {}
...
def firewall_address6_template(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('firewall', 'address6_template', filtered_data, vdom=vdom)
        current_data = fos.get('firewall', 'address6_template', vdom=vdom, mkey=mkey)
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_address6_template')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["firewall_address6_template"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_address6_template"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "firewall_address6_template")
