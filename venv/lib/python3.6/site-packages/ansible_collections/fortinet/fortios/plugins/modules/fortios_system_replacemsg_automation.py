...
def fortios_system_replacemsg(data, fos):
    ...
    fos.do_member_operation('system_replacemsg_automation')
    if data['system_replacemsg_automation']:
        resp = system_replacemsg_automation(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('system_replacemsg_automation'))
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_replacemsg_automation"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["system_replacemsg_automation"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_replacemsg_automation")
