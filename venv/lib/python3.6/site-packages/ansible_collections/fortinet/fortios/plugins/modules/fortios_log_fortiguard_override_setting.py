...
def filter_log_fortiguard_override_setting_data(json):
    option_list = ['max_log_rate', 'override', 'priority',
...
def fortios_log_fortiguard(data, fos):
    ...
    fos.do_member_operation('log_fortiguard_override_setting')
    if data['log_fortiguard_override_setting']:
        resp = log_fortiguard_override_setting(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('log_fortiguard_override_setting'))
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["log_fortiguard_override_setting"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["log_fortiguard_override_setting"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "log_fortiguard_override_setting")
