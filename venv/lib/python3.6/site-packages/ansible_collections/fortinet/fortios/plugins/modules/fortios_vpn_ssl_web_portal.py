...
def filter_vpn_ssl_web_portal_data(json):
    option_list = ['allow_user_access', 'auto_connect', 'bookmark_group',
                   'clipboard', 'custom_lang', 'customize_forticlient_download_url',
                   'display_bookmark', 'display_connection_tools', 'display_history',
                   'display_status', 'dns_server1', 'dns_server2',
                   'dns_suffix', 'exclusive_routing', 'forticlient_download',
                   'forticlient_download_method', 'heading', 'hide_sso_credential',
                   'host_check', 'host_check_interval', 'host_check_policy',
                   'ip_mode', 'ip_pools', 'ipv6_dns_server1',
                   'ipv6_dns_server2', 'ipv6_exclusive_routing', 'ipv6_pools',
                   'ipv6_service_restriction', 'ipv6_split_tunneling', 'ipv6_split_tunneling_routing_address',
                   'ipv6_split_tunneling_routing_negate', 'ipv6_tunnel_mode', 'ipv6_wins_server1',
                   ...
                   'os_check_list', 'prefer_ipv6_dns', 'redir_url',
                   'rewrite_ip_uri_ui', 'save_password', 'service_restriction',
                   'skip_check_for_browser', 'skip_check_for_unsupported_browser', 'skip_check_for_unsupported_os',
                   'smb_max_version', 'smb_min_version', 'smb_ntlmv1_auth',
                   'smbv1', 'split_dns', 'split_tunneling',
                   'split_tunneling_routing_address', 'split_tunneling_routing_negate', 'theme',
                   'transform_backward_slashes', 'tunnel_mode', 'use_sdwan',
...
def vpn_ssl_web_portal(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('vpn_ssl_web', 'portal', filtered_data, vdom=vdom)
        current_data = fos.get('vpn_ssl_web', 'portal', vdom=vdom, mkey=mkey)
...
def fortios_vpn_ssl_web(data, fos, check_mode):
    ...
    fos.do_member_operation('vpn_ssl_web_portal')
