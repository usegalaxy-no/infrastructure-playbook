...
def user_security_exempt_list(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('user', 'security_exempt_list', filtered_data, vdom=vdom)
        current_data = fos.get('user', 'security_exempt_list', vdom=vdom, mkey=mkey)
...
def fortios_user(data, fos, check_mode):
    ...
    fos.do_member_operation('user_security_exempt_list')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["user_security_exempt_list"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["user_security_exempt_list"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "user_security_exempt_list")
