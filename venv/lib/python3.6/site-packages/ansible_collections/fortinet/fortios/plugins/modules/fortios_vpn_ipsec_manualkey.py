...
def vpn_ipsec_manualkey(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('vpn_ipsec', 'manualkey', filtered_data, vdom=vdom)
        current_data = fos.get('vpn_ipsec', 'manualkey', vdom=vdom, mkey=mkey)
...
def fortios_vpn_ipsec(data, fos, check_mode):
    ...
    fos.do_member_operation('vpn_ipsec_manualkey')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["vpn_ipsec_manualkey"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "vpn_ipsec_manualkey")
