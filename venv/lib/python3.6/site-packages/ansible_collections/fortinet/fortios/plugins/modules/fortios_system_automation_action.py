  ...
  - name: fortios_system_automation_action
    fortios_system_automation_action:
      ...
      system_automation_action:
        ...
        alicloud_function_domain: fc.aliyuncs.com
        aws_domain: amazonaws.com
        azure_domain: azurewebsites.net
        azure_function_authorization: anonymous
        delay: 0
        gcp_function_domain: cloudfunctions.net
        message: '%%log%%'
        method: post
        minimum_interval: 0
...
def system_automation_action(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('system', 'automation_action', filtered_data, vdom=vdom)
        current_data = fos.get('system', 'automation_action', vdom=vdom, mkey=mkey)
...
def fortios_system(data, fos, check_mode):
    ...
    fos.do_member_operation('system_automation_action')
