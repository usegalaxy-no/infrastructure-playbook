...
def filter_firewall_gtp_data(json):
    option_list = ['addr_notify', 'apn', 'apn_filter',
                   ...
                   'port_notify', 'rat_timeout_profile', 'rate_limit_mode',
                   'rate_limited_log', 'rate_sampling_interval', 'remove_if_echo_expires',
                   'remove_if_recovery_differ', 'reserved_ie', 'send_delete_when_timeout',
                   'send_delete_when_timeout_v2', 'spoof_src_addr', 'state_invalid_log',
                   'sub_second_interval', 'sub_second_sampling', 'traffic_count_log',
                   'tunnel_limit', 'tunnel_limit_log', 'tunnel_timeout',
                   'unknown_version_action', 'user_plane_message_rate_limit', 'warning_threshold']
    dictionary = {}
...
def flatten_multilists_attributes(data):
    multilist_attrs = [
        [u'policy', u'rat_type'],
        [u'policy', u'messages'],
        [u'policy', u'apn_sel_mode'],
        [u'ie_remove_policy', u'remove_ies'],
        [u'policy_v2', u'rat_type'],
        [u'policy_v2', u'messages'],
        [u'policy_v2', u'apn_sel_mode'],
        [u'imsi', u'selection_mode'],
...
def fortios_firewall(data, fos):
    ...
    fos.do_member_operation('firewall_gtp')
