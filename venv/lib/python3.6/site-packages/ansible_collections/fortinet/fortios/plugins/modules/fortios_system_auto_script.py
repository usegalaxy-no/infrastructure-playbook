...
def system_auto_script(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('system', 'auto_script', filtered_data, vdom=vdom)
        current_data = fos.get('system', 'auto_script', vdom=vdom, mkey=mkey)
...
def fortios_system(data, fos, check_mode):
    ...
    fos.do_member_operation('system_auto_script')
