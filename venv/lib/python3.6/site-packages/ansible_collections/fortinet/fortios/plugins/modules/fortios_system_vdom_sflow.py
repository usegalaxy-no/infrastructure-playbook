...
def filter_system_vdom_sflow_data(json):
    option_list = ['collector_ip', 'collector_port', 'interface',
                   'interface_select_method', 'source_ip', 'vdom_sflow']
    dictionary = {}
...
def fortios_system(data, fos):
    ...
    fos.do_member_operation('system_vdom_sflow')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_vdom_sflow"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_vdom_sflow")
