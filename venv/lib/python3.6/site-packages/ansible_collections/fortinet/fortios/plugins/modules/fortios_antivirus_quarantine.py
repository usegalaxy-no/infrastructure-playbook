...
def filter_antivirus_quarantine_data(json):
    option_list = ['agelimit', 'destination', 'drop_blocked',
                   ...
                   'drop_machine_learning', 'lowspace', 'maxfilesize',
                   'quarantine_quota', 'store_blocked', 'store_heuristic',
                   'store_infected', 'store_intercepted', 'store_machine_learning']
    dictionary = {}
...
def fortios_antivirus(data, fos):
    ...
    fos.do_member_operation('antivirus_quarantine')
