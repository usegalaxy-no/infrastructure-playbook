...
def system_physical_switch(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('system', 'physical_switch', filtered_data, vdom=vdom)
        current_data = fos.get('system', 'physical_switch', vdom=vdom, mkey=mkey)
...
def fortios_system(data, fos, check_mode):
    ...
    fos.do_member_operation('system_physical_switch')
