...
def fortios_wanopt(data, fos):
    ...
    fos.do_member_operation('wanopt_settings')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["wanopt_settings"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "wanopt_settings")
