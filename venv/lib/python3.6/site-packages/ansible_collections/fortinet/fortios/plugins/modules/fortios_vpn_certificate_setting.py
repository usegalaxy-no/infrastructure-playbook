...
def filter_vpn_certificate_setting_data(json):
    option_list = ['certname_dsa1024', 'certname_dsa2048', 'certname_ecdsa256',
                   'certname_ecdsa384', 'certname_ecdsa521', 'certname_ed25519',
                   'certname_ed448', 'certname_rsa1024', 'certname_rsa2048',
                   'certname_rsa4096', 'check_ca_cert', 'check_ca_chain',
                   'cmp_key_usage_checking', 'cmp_save_extra_certs', 'cn_allow_multi',
                   'cn_match', 'crl_verification', 'interface',
                   'interface_select_method', 'ocsp_default_server', 'ocsp_option',
                   'ocsp_status', 'ssl_min_proto_version', 'ssl_ocsp_option',
                   'ssl_ocsp_source_ip', 'ssl_ocsp_status', 'strict_crl_check',
                   'strict_ocsp_check', 'subject_match', 'subject_set']
    dictionary = {}
...
def fortios_vpn_certificate(data, fos):
    ...
    fos.do_member_operation('vpn_certificate_setting')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["vpn_certificate_setting"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["vpn_certificate_setting"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "vpn_certificate_setting")
