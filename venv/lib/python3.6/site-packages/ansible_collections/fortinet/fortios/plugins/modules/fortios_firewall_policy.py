...
def filter_firewall_policy_data(json):
    option_list = ['action', 'anti_replay', 'app_category',
                   ...
                   'delay_tcp_npu_session', 'devices', 'diffserv_forward',
                   'diffserv_reverse', 'diffservcode_forward', 'diffservcode_rev',
                   'disclaimer', 'dlp_sensor', 'dnsfilter_profile',
                   'dscp_match', 'dscp_negate', 'dscp_value',
                   'dsri', 'dstaddr', 'dstaddr_negate',
                   'dstaddr6', 'dstintf', 'dynamic_shaping',
                   'email_collect', 'emailfilter_profile', 'file_filter_profile',
                   'firewall_session_dirty', 'fixedport', 'fsso',
                   'fsso_agent_for_ntlm', 'fsso_groups', 'geoip_anycast',
                   'geoip_match', 'global_label', 'groups',
                   'gtp_profile', 'http_policy_redirect', 'icap_profile',
                   ...
                   'internet_service_src_name', 'internet_service_src_negate', 'ippool',
                   'ips_sensor', 'label', 'learning_mode',
                   'logtraffic', 'logtraffic_start', 'match_vip',
                   'match_vip_only', 'mms_profile', 'name',
                   'nat', 'nat46', 'nat64',
                   'natinbound', 'natip', 'natoutbound',
                   'np_acceleration', 'ntlm', 'ntlm_enabled_browsers',
                   'ntlm_guest', 'outbound', 'passive_wan_health_measurement',
                   'per_ip_shaper', 'permit_any_host', 'permit_stun_host',
                   'pfcp_profile', 'policyid', 'poolname',
                   'poolname6', 'profile_group', 'profile_protocol_options',
                   'profile_type', 'radius_mac_auth_bypass', 'redirect_url',
                   'replacemsg_override_group', 'reputation_direction', 'reputation_minimum',
                   'rsso', 'rtp_addr', 'rtp_nat',
                   'scan_botnet_connections', 'schedule', 'schedule_timeout',
                   'sctp_filter_profile', 'send_deny_packet', 'service',
                   'service_negate', 'session_ttl', 'sgt',
                   'sgt_check', 'spamfilter_profile', 'src_vendor_mac',
                   ...
                   'utm_status', 'uuid', 'videofilter_profile',
                   ...
                   'ztna_ems_tag', 'ztna_geo_tag', 'ztna_status']
    dictionary = {}
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_policy')
    if data['action'] == 'move':
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["firewall_policy"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "firewall_policy")
