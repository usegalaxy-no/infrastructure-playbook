...
def firewall_ssh_local_key(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('firewall_ssh', 'local_key', filtered_data, vdom=vdom)
        current_data = fos.get('firewall_ssh', 'local_key', vdom=vdom, mkey=mkey)
...
def fortios_firewall_ssh(data, fos, check_mode):
    ...
    fos.do_member_operation('firewall_ssh_local_key')
