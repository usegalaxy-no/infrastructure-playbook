...
def fortios_icap(data, fos, check_mode):
    ...
    fos.do_member_operation('icap_server')
    if data['icap_server']:
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["icap_server"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "icap_server")
