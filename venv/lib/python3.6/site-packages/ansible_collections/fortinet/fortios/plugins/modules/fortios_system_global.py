...
def filter_system_global_data(json):
    option_list = ['admin_concurrent', 'admin_console_timeout', 'admin_forticloud_sso_login',
                   ...
                   'clt_cert_req', 'cmdbsvr_affinity', 'compliance_check',
                   'compliance_check_time', 'cpu_use_threshold', 'csr_ca_attribute',
                   'daily_restart', 'default_service_source_port', 'device_identification_active_scan_delay',
                   'device_idle_timeout', 'dh_params', 'dnsproxy_worker_count',
                   'dst', 'edit_vdom_prompt', 'endpoint_control_fds_access',
                   'endpoint_control_portal_port', 'failtime', 'faz_disk_buffer_size',
                   'fds_statistics', 'fds_statistics_period', 'fec_port',
                   'fgd_alert_subscription', 'fortiextender', 'fortiextender_data_port',
                   'fortiextender_vlan_mode', 'fortiipam_integration', 'fortiservice_port',
                   ...
                   'gui_firmware_upgrade_warning', 'gui_forticare_registration_setup_warning', 'gui_fortigate_cloud_sandbox',
                   'gui_fortisandbox_cloud', 'gui_ipv6', 'gui_lines_per_page',
                   'gui_local_out', 'gui_replacement_message_groups', 'gui_rest_api_cache',
                   'gui_theme', 'gui_wireless_opensecurity', 'ha_affinity',
                   'honor_df', 'hostname', 'igmp_state_limit',
                   'interval', 'ip_src_port_range', 'ips_affinity',
                   'ipsec_asic_offload', 'ipsec_ha_seqjump_rate', 'ipsec_hmac_offload',
                   'ipsec_soft_dec_async', 'ipv6_accept_dad', 'ipv6_allow_anycast_probe',
                   'ipv6_allow_traffic_redirect', 'irq_time_accounting', 'language',
                   'ldapconntimeout', 'lldp_reception', 'lldp_transmission',
                   'log_ssl_connection', 'log_uuid', 'log_uuid_address',
                   'log_uuid_policy', 'login_timestamp', 'long_vdom_name',
                   'management_ip', 'management_port', 'management_port_use_admin_sport',
                   ...
                   'per_user_bal', 'per_user_bwl', 'pmtu_discovery',
                   ...
                   'proxy_auth_timeout', 'proxy_cipher_hardware_acceleration', 'proxy_hardware_acceleration',
                   'proxy_kxp_hardware_acceleration', 'proxy_re_authentication_mode', 'proxy_resource_mode',
                   ...
                   'speedtest_server', 'split_port', 'ssd_trim_date',
                   ...
                   'ssl_static_key_ciphers', 'sslvpn_cipher_hardware_acceleration', 'sslvpn_ems_sn_check',
                   'sslvpn_kxp_hardware_acceleration', 'sslvpn_max_worker_count', 'sslvpn_plugin_version_check',
                   ...
                   'tcp_halfopen_timer', 'tcp_option', 'tcp_rst_timer',
                   ...
                   'url_filter_affinity', 'url_filter_count', 'user_device_store_max_devices',
                   'user_device_store_max_users', 'user_server_cert', 'vdom_admin',
                   'vdom_mode', 'vip_arp_range', 'virtual_server_count',
                   'virtual_server_hardware_acceleration', 'wad_affinity', 'wad_csvc_cs_count',
                   'wad_csvc_db_count', 'wad_memory_change_granularity', 'wad_source_affinity',
...
def flatten_multilists_attributes(data):
    multilist_attrs = [
        [u'admin_https_ssl_versions'],
        [u'fgd_alert_subscription'],
    ]
