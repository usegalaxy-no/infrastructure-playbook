...
def filter_firewall_pfcp_data(json):
    option_list = ['denied_log', 'forwarded_log', 'invalid_reserved_field',
                   'log_freq', 'max_message_length', 'message_filter',
                   'min_message_length', 'monitor_mode', 'name',
                   'pfcp_timeout', 'traffic_count_log', 'unknown_version']
    dictionary = {}
...
def fortios_firewall(data, fos):
    ...
    fos.do_member_operation('firewall_pfcp')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["firewall_pfcp"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "firewall_pfcp")
