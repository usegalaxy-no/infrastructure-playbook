...
def fortios_spamfilter(data, fos, check_mode):
    ...
    fos.do_member_operation('spamfilter_bwl')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["spamfilter_bwl"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "spamfilter_bwl")
