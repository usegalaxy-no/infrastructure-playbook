...
def filter_firewall_access_proxy_virtual_host_data(json):
    option_list = ['host', 'host_type', 'name',
                   'ssl_certificate']
    dictionary = {}
...
def fortios_firewall(data, fos):
    ...
    fos.do_member_operation('firewall_access_proxy_virtual_host')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["firewall_access_proxy_virtual_host"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_access_proxy_virtual_host"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "firewall_access_proxy_virtual_host")
