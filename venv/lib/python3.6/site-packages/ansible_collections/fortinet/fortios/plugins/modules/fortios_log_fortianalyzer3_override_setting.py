...
- collections:
  ...
  vars:
    ...
    vdom: root
  tasks:
  - name: fortios_log_fortianalyzer3_override_setting
...
def fortios_log_fortianalyzer3(data, fos):
    ...
    fos.do_member_operation('log_fortianalyzer3_override_setting')
    if data['log_fortianalyzer3_override_setting']:
        resp = log_fortianalyzer3_override_setting(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('log_fortianalyzer3_override_setting'))
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["log_fortianalyzer3_override_setting"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["log_fortianalyzer3_override_setting"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "log_fortianalyzer3_override_setting")
