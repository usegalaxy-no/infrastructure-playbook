...
def filter_firewall_access_proxy6_data(json):
    option_list = ['api_gateway', 'api_gateway6', 'client_cert',
                   'empty_cert_action', 'name', 'vip']
    dictionary = {}
...
def flatten_multilists_attributes(data):
    multilist_attrs = [
        [u'api_gateway', u'ssl_cipher_suites', u'versions'],
        [u'api_gateway6', u'ssl_cipher_suites', u'versions'],
    ]
...
def fortios_firewall(data, fos):
    ...
    fos.do_member_operation('firewall_access_proxy6')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["firewall_access_proxy6"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_access_proxy6"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "firewall_access_proxy6")
