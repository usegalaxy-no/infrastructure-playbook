...
def system_automation_destination(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('system', 'automation_destination', filtered_data, vdom=vdom)
        current_data = fos.get('system', 'automation_destination', vdom=vdom, mkey=mkey)
...
def fortios_system(data, fos, check_mode):
    ...
    fos.do_member_operation('system_automation_destination')
