...
def filter_videofilter_profile_data(json):
    option_list = ['comment', 'dailymotion', 'fortiguard_category',
                   'name', 'replacemsg_group', 'vimeo',
                   'vimeo_restrict', 'youtube', 'youtube_channel_filter',
                   'youtube_restrict']
    dictionary = {}
...
def fortios_videofilter(data, fos):
    ...
    fos.do_member_operation('videofilter_profile')
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["videofilter_profile"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "videofilter_profile")
