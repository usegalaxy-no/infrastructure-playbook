...
- collections:
  ...
  vars:
    ...
    vdom: root
  tasks:
  - name: fortios_wireless_controller_hotspot20_h2qp_osu_provider
...
def wireless_controller_hotspot20_h2qp_osu_provider(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('wireless_controller_hotspot20', 'h2qp_osu_provider', filtered_data, vdom=vdom)
        current_data = fos.get('wireless_controller_hotspot20', 'h2qp_osu_provider', vdom=vdom, mkey=mkey)
...
def fortios_wireless_controller_hotspot20(data, fos, check_mode):
    ...
    fos.do_member_operation('wireless_controller_hotspot20_h2qp_osu_provider')
