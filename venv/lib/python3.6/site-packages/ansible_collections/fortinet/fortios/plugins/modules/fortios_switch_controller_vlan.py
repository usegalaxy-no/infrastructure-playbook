...
def switch_controller_vlan(data, fos, check_mode=False):
    ...
    if check_mode:
        mkey = fos.get_mkey('switch_controller', 'vlan', filtered_data, vdom=vdom)
        current_data = fos.get('switch_controller', 'vlan', vdom=vdom, mkey=mkey)
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    fos.do_member_operation('switch_controller_vlan')
