...
- collections:
  ...
  vars:
    ...
    vdom: root
  tasks:
  - name: fortios_switch_controller_flow_tracking
...
def fortios_switch_controller(data, fos):
    ...
    fos.do_member_operation('switch_controller_flow_tracking')
    if data['switch_controller_flow_tracking']:
        resp = switch_controller_flow_tracking(data, fos)
    else:
        fos._module.fail_json(msg='missing task body: %s' % ('switch_controller_flow_tracking'))
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["switch_controller_flow_tracking"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["switch_controller_flow_tracking"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "switch_controller_flow_tracking")
